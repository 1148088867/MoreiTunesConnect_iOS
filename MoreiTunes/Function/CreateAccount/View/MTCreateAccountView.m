...
#import "MTCreateAccountCell.h"

@interface MTCreateAccountView()<QMUITableViewDelegate, QMUITableViewDataSource>

psx(NSArray<NSDictionary *>, createAccountInfoArr);

@end

@implementation MTCreateAccountView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    MTCreateAccountCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (!cell) {
        cell = [[MTCreateAccountCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
    }
