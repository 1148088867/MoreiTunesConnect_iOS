...
#pragma mark - TextField & TextView
    QMUICMI.textFieldTintColor = nil;                                           // TextFielMTCintColor : QMUITextField、QMUITextView 的 tintColor，不影响 UIKit 的输入框
    QMUICMI.textFieldTextInsets = UIEdgeInsetsMake(0, 7, 0, 7);                 // TextFielMTCextInsets : QMUITextField 的内边距，不影响 UITextField
...
#pragma mark - NavigationBar
    ...
    QMUICMI.navBarTitleFont = UIFontMakeNameWithSize(@"AmericanTypewriter", 20);                                              // NavBarTitleFont : UINavigationBar 的标题字体，以及 QMUINavigationTitleView 的默认字体
...
#pragma mark - TabBar
    ...
    QMUICMI.tabBarTintColor = UIColorBlack;                                              // TabBarTintColor : UITabBar 的 tintColor
    QMUICMI.tabBarItemTitleColor = UIColorGray;                                         // tabBarItemTitleColor : 未选中的 UITabBarItem 的标题颜色
    QMUICMI.tabBarItemTitleColorSelected = TabBarTintColor;                     // tabBarItemTitleColorSelected : 选中的 UITabBarItem 的标题颜色
    QMUICMI.tabBarItemTitleFont = UIFontMakeNameWithSize(@"AmericanTypewriter", 10);                                          // TabBarIteMTCitleFont : UITabBarItem 的标题字体
...
#pragma mark - TableView / TableViewCell
    ...
    QMUICMI.tableViewCellNormalHeight = 64;                                     // TableViewCellNormalHeight : 列表默认的 cell 高度
...
#pragma mark - QMUILog
    QMUICMI.shouldPrintDefaultLog = IS_DEBUG;                                        // ShouldPrintDefaultLog : 是否允许输出 QMUILogLevelDefault 级别的 log
    QMUICMI.shouldPrintInfoLog = IS_DEBUG;                                           // ShouldPrintInfoLog : 是否允许输出 QMUILogLevelInfo 级别的 log
    QMUICMI.shouldPrintWarnLog = IS_DEBUG;                                           // ShouldPrintInfoLog : 是否允许输出 QMUILogLevelWarn 级别的 log
...
#pragma mark - Others
    ...
    QMUICMI.needsBackBarButtonItemTitle = NO;                                   // NeedsBackBarButtonIteMTCitle : 全局是否需要返回按钮的 title，不需要则只显示一个返回image
